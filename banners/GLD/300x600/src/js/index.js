	...
	CRAFTWW.startAd = function() {
		...
		if (isAndroid) {
			...
			tl3.to(copy6, .5, {autoAlpha:1})//this is just to pause
				.to(copy6, .5, {left:181, top:167, scale:1.3, ease:Power1.easeInOut},"allTxt3")
				.to(copy17, .5, {left:-46, top:198, scale:1.3, ease:Power1.easeInOut}, "allTxt3")
				...
				.to(copyHidden3, .4, {autoAlpha:1, ease:Power1.easeInOut, onComplete:step4, delay:.2}, "allTxt3")
				//
		} 
		...
		else if(isIphone)
		{
			...
			TweenMax.set(copyHidden3, {top:221});
			tl3.to(copy6, .5, {autoAlpha:1})//this is just to pause
				.to(copy6, .5, {left:173, top:164, ease:Power1.easeInOut},"allTxt3")
				.to(copy17, .5, {left:-42, top:194, ease:Power1.easeInOut}, "allTxt3")
				.to(copyHidden1, .4, {autoAlpha:1, ease:Power1.easeInOut, delay:.2}, "allTxt3")
				.to(copyHidden2, .4, {autoAlpha:1, ease:Power1.easeInOut, delay:.2}, "allTxt3")
			...
			tl3.to(copy6, .5, {autoAlpha:1})//this is just to pause
				.to(copy6, .5, {left:182, top:154, ease:Power1.easeInOut},"allTxt3")
				.to(copy17, .5, {left:-32, top:183, ease:Power1.easeInOut}, "allTxt3")
				.to(copyHidden1, .4, {autoAlpha:1, ease:Power1.easeInOut, delay:.2}, "allTxt3")
				.to(copyHidden2, .4, {autoAlpha:1, ease:Power1.easeInOut, delay:.2}, "allTxt3")
				.to(copyHidden3, .4, {autoAlpha:1, ease:Power1.easeInOut, delay:.2, onComplete:step4}, "allTxt3")
		}
		...
		function step4() {
			tl4.to([copy6, copy17, copyHidden1, copyHidden2, copyHidden3], .5, {delay:1.5, autoAlpha:0, ease:Power1.easeInOut})
		...
		function step6(){
			...
			tl6.to([logo, frame6], .5, { autoAlpha:0, ease:Power1.easeInOut}, "+=2")
				...
				.to([frameLegal, legalLink, legalLink2], 6.4, {top: '-=149px', ease:Linear.easeNone}, "+=2")
