...
(function() {
	CRAFTWW.startAd = function() {
		...
		function colorChange(_elem, _duration, _ease, _delay){
			...
			setPos(copy1, "visible", 500, 4, 2);
			setPos(copy2, "visible", -250, 33, 3);
			setPos(copy3, "visible", 500, 60, 4);
			...
			setPos(frameLegal, "hidden", 0, -3, 1002);
			setPos(legalLink, "visible", 211, 133, 1003);
			setPos(legalLink2, "visible", 158, 144, 1004);
			...
			setPos(markets, "hidden", 198, 33, 13);
			setPos(diversify, "hidden", 466, 60, 14);
		...
		function step2(){	
				...
				tl2.to(copy1, 22, {left:copy1w, ease:Power1.easeInOut},"allTxt2")
					...
					.to(diversify, .75, {autoAlpha:1, onComplete:step3},"allTxt2")
					//
		...
		if (isAndroid) {
			...
			tl3.to([diversify, markets], .6, {autoAlpha:1})//this is just to pause
				.to(markets, .6, {left:109, top:34, ease:Power1.easeInOut},"allTxt3")
				.to(diversify, .6, {left:218, top:34, ease:Power1.easeInOut}, "allTxt3")
		...
		function step6(){
			...
			tl6.to([logo, frame6], .5, { autoAlpha:0, ease:Power1.easeInOut}, "+=2")
				...
				.to([frameLegal, legalLink, legalLink2], 6, {y: '-=172px', ease:Linear.easeNone, rotationz:.001}, "+=2")	
