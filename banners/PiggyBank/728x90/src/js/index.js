...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		TweenMax.delayedCall(7.2, inkingAnimate)
	...
	function inkingAnimate() {
		...
		for (var i = 0; i < coins.length; i++) {
		 ...
		 // paths[i].style["stroke-dasharray"] = 10;
		  ...
		  coin_tl.fromTo(coinsArray[i], getRandom(0.3, 0.75),{x:150, y:-35, autoAlpha:1,rotationZ:getRandom(0, 40),rotationY:getRandom(0, 40)}, {x:posXArray2[i], y:posYArray2[i], autoAlpha:1,ease:Cubic.easeIn,rotationX:getRandom(0, 20),rotationY:getRandom(0, 20)}, ["-=" + getRandom(0.09, 0.5)])
	//	 coin_tl.fromTo(coinsArray[i], getRandom(0.3, 0.55),{x:150, y:-75, autoAlpha:1}, {x:getRandom(100, 220), y:getRandom(10, 80), autoAlpha:1,ease:Cubic.easeIn}, ["-=" + getRandom(0.09, 0.5)])
		...
		function trickleAnimate() {
			...
			for (var i = 0; i < tcoins.length; i++) {
			  ...
			  tcoin_tl.fromTo(tcoinsArray[i], getRandom(0.3, 0.75),{x:150, y:-35, autoAlpha:1,rotationZ:getRandom(0, 40),rotationY:getRandom(0, 40)}, {x:posXArray1[i], y:posYArray1[i], autoAlpha:1,ease:Cubic.easeIn,rotationZ:getRandom(0, 30),rotationY:getRandom(0, 20)}, ["-=" + getRandom(0.09, 0.5)])
