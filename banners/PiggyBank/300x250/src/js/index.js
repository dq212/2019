...
( function () {
	...
	nameSpace.init = function () {
			...
			posYArray1 = [10, 23, 15, 20, 27, 10, 8, 6, 4, 14, 12 ];
...
click_through.onmouseover = function () {	
	TweenMax.to("#cta", 0.2, {scale:1.1, y:0, transformOrigin:"75% 65%", z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 400});
};
...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline.to("#copy-1", 0.8, {x:0, autoAlpha:1})
				...
				.to(["#pig", "#coin-holder", "#coin-holder2"], 0.8, {x:width, ease: Linear.easeIn}, "-=0.7")
