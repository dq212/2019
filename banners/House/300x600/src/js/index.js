	...
	nameSpace.init = function () {
		...
		height = 600;
			...
			//
				 ...
				 TweenMax.set("#outline", {scale:4.25});
...
click_through.onmouseout = function () {
	...
	function animateSmoke() {
		...
		var ts = new TimelineMax();
			ts.fromTo("#s1", 2, {y:50, autoAlpha:1}, {y:-20, autoAlpha:0})
			.fromTo("#s2", 2, {y:50, autoAlpha:1}, {y:-20, autoAlpha:0}, "-=2")
			.fromTo("#s3", 2, {y:50, autoAlpha:1}, {y:-20, autoAlpha:0,onComplete:animateSmoke}, "-=2");
		}
	}
