...
(function () {
	...
	nameSpace.initAnimation = function () {
		...
		.to(['#hand'], 0.5, { y: -28, x: -75, transformStyle: "preserve-3d", autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power1.easeOut }, "+=1.5")
