...
(function () {
	...
	nameSpace.init = function () {
		...
		click_through.onmouseover = function () {
			TweenMax.to("#cta", 0.1, { scale: 1.1, y: 0, transformOrigin: "50% 83%", z: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		};
	...
	nameSpace.initAnimation = function () {
		...
		.to(['#hand'], 0.5, { y: -28, x: -35, transformStyle: "preserve-3d", autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power1.easeOut }, "+=1.5")
		...
		.to(["#copy-1", "#line", "#btn-minus", "#btn-plus", "#hand", "#allNums"], 0, { autoAlpha: 0, transformPerspective: 400, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=2.25")
			...
			// .fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 1, transformPerspective: 160, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, '+=0.5')
