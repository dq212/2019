...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set('#hand', { x: 80, y: 45 });
		TweenMax.set(['#hand', "#btn-plus", "#btn-minus"], {autoAlpha: 1 });
		TweenMax.set(["#copy-2", "#copy-3", "#copy-4"], { x: 0, autoAlpha: 0 });
	...
	nameSpace.initAnimation = function () {
		...
		.to(['#hand'], 0.5, { y: -15, x: -158, transformStyle: "preserve-3d", autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power1.easeOut }, "+=1.5")
		...
		.to(["#copy-1", "#line", "#btn-minus", "#btn-plus", "#hand", "#allNums"], 0, { autoAlpha: 0, transformPerspective: 400, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=2.25")
			...
			// .fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 1, transformPerspective: 970, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, '+=0.5')
