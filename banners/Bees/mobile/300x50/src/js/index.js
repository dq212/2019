...
( function () {
	...
	nameSpace.init = function () {
			...
			height = 50;
			ba = [];
		    bs =  [{x:25, y:220, s:0.4, r:-20, ex:-100, ey:-100},  {x:200, y:200, s:0.45, r:-180, ex:-200, ey:-200},{x:230, y:300, s:0.5, r:-50, ex:-200, ey:-200},  {x:10, y:340, s:0.6, r:0, ex:-200, ey:-200},  {x:100, y:160, s:0.45, r:-60, ex:-200, ey:-200},{x:220, y:230, s:0.47, r:-120, ex:-200, ey:-200},  {x:20, y:470, s:0.47, r:0, ex:-200, ey:-200},  {x:150, y:500, s:0.45, r:-40, ex:-200, ey:-200},{x:100, y:130, s:0.5, r:0, ex:-200, ey:-200},{x:200, y:440, s:0.45, r:0, ex:-200, ey:-200 } ];
			...
			for (var q = 0; q<allElements.length; q++){
				 ...
				 TweenMax.set(["#cta", "#code", "#logo"], {autoAlpha:0});
				 TweenMax.set(["#copy-1", "#copy-2", "#copy-3"],{y: height});
...
click_through.onmouseover = function () {	
	// TweenMax.to("#cta", 0.2, {scale:1.1, y:0, transformOrigin:"652px 22px", z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 400});
};
...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline.to("#copy-1", 0.8, {y:0, autoAlpha:1, delay:1})
				.to("#copy-1", 0.8, {y: -height},"+=3")
				.fromTo("#copy-2", 0.8, {y: height, autoAlpha:1}, {y:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Linear.easeNone}, "-=0.8")
				.to(["#copy-2"], 0.8, {y: -height,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "+=2.8")
				.fromTo("#copy-3", 1, {y: height, autoAlpha:1}, {y:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "-=.8")
				.fromTo("#icon",0.8, {y: height, autoAlpha:0}, { y:0, autoAlpha:1, ease:Power1.easeInOut}, "-=.5")
				//.to("#copy-3", 0.8, {y: -height}, "+=3")
				//.fromTo("#copy-4", 1, {y: height, autoAlpha:1}, {y:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "-=.7")
...
// 	}
	...
	function moveDirection2() {
		...
		// 	//t.to(ba[i], 3, {x:bs[i].ex, y:bs[i].ey, ease:Power2.easeInOut, autoRotate:50, onComplete:fadeOutBees}, "-=3");
		// 	// .to(ba[i],getRandom(0.8, 1.5), {x:getRandom(140,170), y:getRandom(270, 160), ease:Power2.easeInOut}, -(getRandom(0.8, 1.5)))
		// 	//TweenMax.to(ba[i], 3, { x:150, y:160, scale:.5});
		// }
		...
		TweenMax.set("#hive", {x:10, y:10});
					...
					t.to(ba[0], 1.5, {scale:0.4, bezier:{values:motionPath11, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
					t.to(ba[1], 1.25, {scale:0.4, bezier:{values:motionPath12, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 }, "-=1.1");
					t.to(ba[2], 1.5, {scale:0.4, bezier:{values:motionPath13, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 },"-=1.5");
					t.to(ba[3], 1.25, {scale:0.4, bezier:{values:motionPath14, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 }, "-=1.25");
	...
	function directionChange() {
		...
		TweenMax.to(ba[5], 4, {bezier:{values:motionPath, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		TweenMax.to(ba[6], 4, {bezier:{values:motionPath, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 , delay:0.3});
		TweenMax.to(ba[7], 4, {bezier:{values:motionPath, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0, delay:0.6 });
		var motionPath2 = MorphSVGPlugin.pathDataToBezier('#path-right') ;
		TweenMax.to(ba[8], 4, {bezier:{values:motionPath2, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0, delay:0 });
		TweenMax.to(ba[9], 4, {bezier:{values:motionPath2, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0, delay:0.3 });
		TweenMax.to(ba[3], 4, {bezier:{values:motionPath2, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0, delay:0.6 });
		var motionPath3 = MorphSVGPlugin.pathDataToBezier('#path-middle');
		TweenMax.to(ba[4], 4, {bezier:{values:motionPath2, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0, delay:0 });
	}

	function animateBees() {	
		// bs = [{x:25, y:220, s:0.7, r:-20},  {x:200, y:200, s:0.7, r:-180}, {x:230, y:300, s:1, r:-50},  {x:10, y:340, s:1.25, r:0},  {x:100, y:300, s:.5, r:-60}, {x:220, y:230, s:.55, r:-120},  {x:20, y:470, s:.55, r:0},  {x:150, y:500, s:0.7, r:-40},{x:100, y:130, s:1, r:0},{x:200, y:440, s:.6, r:0} ]
		...
		TweenMax.to(ba[0], 6.5, {bezier:{values:motionPath, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath2 = MorphSVGPlugin.pathDataToBezier('#path2') ;
		TweenMax.to(ba[1], 6.5, {bezier:{values:motionPath2, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0});
		var motionPath3 = MorphSVGPlugin.pathDataToBezier('#path3') ;
		TweenMax.to(ba[2], 6.5, {bezier:{values:motionPath3, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath4 = MorphSVGPlugin.pathDataToBezier('#path4') ;
		TweenMax.to(ba[3], 6.5, {bezier:{values:motionPath4, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath5 = MorphSVGPlugin.pathDataToBezier('#path5') ;
		TweenMax.to(ba[4], 6.5, {bezier:{values:motionPath5, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath6 = MorphSVGPlugin.pathDataToBezier('#path6') ;
		TweenMax.to(ba[5], 6.5, {bezier:{values:motionPath6, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath7 = MorphSVGPlugin.pathDataToBezier('#path7') ;
		TweenMax.to(ba[6], 6.5, {bezier:{values:motionPath7, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
		var motionPath8 = MorphSVGPlugin.pathDataToBezier('#path8') ;
		TweenMax.to(ba[7], 6, {bezier:{values:motionPath8, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });

		var motionPath9 = MorphSVGPlugin.pathDataToBezier('#path9') ;
		TweenMax.to(ba[8], 6.5, {bezier:{values:motionPath9, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });

		var motionPath10 = MorphSVGPlugin.pathDataToBezier('#path10') ;
		TweenMax.to(ba[9], 6.5, {bezier:{values:motionPath10, type:"cubic", autoRotate:50}, ease:Linear.easeNone, repeat: 0 });
	}
