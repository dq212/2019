...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline.to("#copy-1", 0.8, {x:0, autoAlpha:1, delay:1})
				...
				.fromTo("#copy-2", 0.8, {x:-160, autoAlpha:1}, {x:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Linear.easeNone}, "-=0.8")
				.to(["#copy-2"], 0.8, {x:160,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "+=2.8")
				.fromTo("#copy-3", 1, {x:-160, autoAlpha:1}, {x:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "-=.8")
				.fromTo("#icon",0.8, {x:-width, autoAlpha:0}, { x:0, autoAlpha:1, ease:Power1.easeInOut}, "-=.5")
				.to("#copy-3", 0.8, {x:width}, "+=3")
				.fromTo("#copy-4", 1, {x:-160, autoAlpha:1}, {x:0,autoAlpha:1,transformStyle: "preserve-3d", force3D:true, rotationZ: 0.01, ease:Cubic.easeInOut}, "-=.7")
...
// 	}
	...
	function animateBees() {	
		// bs = [{x:25, y:220, s:0.7, r:-20},  {x:200, y:200, s:0.7, r:-180}, {x:230, y:320, s:1, r:-90},  {x:10, y:340, s:1.25, r:0},  {x:100, y:160, s:.5, r:-60}, {x:220, y:230, s:.55, r:-120},  {x:20, y:470, s:.55, r:0},  {x:150, y:500, s:0.7, r:-40},{x:100, y:130, s:1, r:0},{x:200, y:440, s:.6, r:0} ]
