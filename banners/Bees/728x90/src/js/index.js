...
( function () {
	...
	nameSpace.init = function () {
			...
			height = 90;
			ba = [];
		    bs =  [{x:25, y:220, s:0.4, r:-20, ex:-100, ey:-100},  {x:200, y:200, s:0.45, r:-180, ex:-200, ey:-200},{x:230, y:320, s:0.5, r:-90, ex:-200, ey:-200},  {x:10, y:340, s:0.6, r:0, ex:-200, ey:-200},  {x:100, y:160, s:0.45, r:-60, ex:-200, ey:-200},{x:220, y:230, s:0.47, r:-120, ex:-200, ey:-200},  {x:20, y:470, s:0.47, r:0, ex:-200, ey:-200},  {x:150, y:500, s:0.45, r:-40, ex:-200, ey:-200},{x:100, y:130, s:0.5, r:0, ex:-200, ey:-200},{x:200, y:440, s:0.45, r:0, ex:-200, ey:-200 } ];
...
// 	}
	...
	function moveDirection2() {
		...
		TweenMax.set("#hive", {x:10, y:10});
					...
					t.to(ba[0], 1.5, {scale:0.4, bezier:{values:motionPath11, type:"cubic", autoRotate:90}, ease:Linear.easeNone, repeat: 0 });
					t.to(ba[1], 1.25, {scale:0.4, bezier:{values:motionPath12, type:"cubic", autoRotate:90}, ease:Linear.easeNone, repeat: 0 }, "-=1.1");
					t.to(ba[2], 1.5, {scale:0.4, bezier:{values:motionPath13, type:"cubic", autoRotate:90}, ease:Linear.easeNone, repeat: 0 },"-=1.5");
					t.to(ba[3], 1.25, {scale:0.4, bezier:{values:motionPath14, type:"cubic", autoRotate:90}, ease:Linear.easeNone, repeat: 0 }, "-=1.25");
	...
	function directionChange() {
		...
		TweenMax.to(ba[3], 4, {bezier:{values:motionPath2, type:"cubic", autoRotate:90}, ease:Linear.easeNone, repeat: 0, delay:0.6 });
	...
	function animateBees() {	
		// bs = [{x:25, y:220, s:0.7, r:-20},  {x:200, y:200, s:0.7, r:-180}, {x:230, y:320, s:1, r:-90},  {x:10, y:340, s:1.25, r:0},  {x:100, y:728, s:.5, r:-60}, {x:220, y:230, s:.55, r:-120},  {x:20, y:470, s:.55, r:0},  {x:150, y:500, s:0.7, r:-40},{x:100, y:130, s:1, r:0},{x:200, y:440, s:.6, r:0} ]
