...
// };
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.fromTo(['#bumper-2'], 1.5, {x:width*2},{x:-148 , ease:Power2.easeNone}, '-=1.3')
			
			.to(['#bumper-1'], 0.2, {x:68, ease:Power4.easeNone}, "-=0.2")
			.to(['#bumper-2'], 0.3, {x:-142, ease:Power4.easeNone}, "-=0.1")
			.to(['#bumper-1'], 0.2, {x:70, ease:Power2.easeNone}, "-=0.1")
