	...
	nameSpace.init = function () {
		...
		height = 600;
			...
			for (var q = 0; q<allElements.length; q++){
				...
				TweenMax.set("#check-3", {x:-width*2, rotation:100})
...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline.to("#copy-1", 0.8, {x:0, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01, ease:Power1.easeOut})
			...
			.to(['#bumper-2'], 1,  {x:-600, ease:Power1.easeOut})
			...
			.to(['#check-3'], 1, { scale:0.7, transformOrigin:"50% 50%", ease:Power2.easeOut,scale:1, x:0, y:0, rotation:0, ease:Power2.easeOut} ,'-=0.3')
