	...
	nameSpace.init = function () {
		...
		height = 90;
			...
			for (var q = 0; q<allElements.length; q++){
				...
				TweenMax.set('#check-3', {rotation:100, x:-width});
...
click_through.onmouseout = function () {
	...
	nameSpace.initAnimation = function () {
		...
		timeline.to("#copy-1", 0.8, {y:0, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01, ease:Power1.easeOut})
			...
			.to(["#copy-1"], 0.8, {y:height, transformPerspective: 400, autoAlpha:1, force3D:true, rotationZ: 0.01, ease:Power1.easeIn}, "+=.5")
			.fromTo("#copy-2", 0.8, {y:-height}, {y:0,transformPerspective: 400,force3D:true, rotationZ: 0.01,ease:Power2.easeOut},"-=0.2")
			...
			.to(['#bumper-2'], 1,  {x:-680, ease:Power1.easeOut})
			
			.to(["#copy-2"], 0.8, {y:height, transformPerspective: 400, autoAlpha:1, force3D:true, rotationZ: 0.01, ease:Power1.easeOut}, "+=0.6")
			...
			.to(["#copy-3"], 0.8, {y:height, transformPerspective: 400, autoAlpha:1, force3D:true, rotationZ: 0.01, ease:Power4.easeNone}, "-=1")
			...
			.to(["#copy-5"], 0.4, { autoAlpha:1, transformPerspective: 400, force3D:true, rotationZ: 0.01, ease:Power2.easeIn})	
