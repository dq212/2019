...
(function () {
	...
	nameSpace.init = function () {
		...
		// TweenMax.set("#rooster", {x:250, y:200, scale:2});
		TweenMax.set("#rooster-object",{scale:1.6, x:350, y:125});
		...
		TweenMax.set(["#rooster"], { scale:1.6});
		...
		click_through.onmouseover = function () {
			TweenMax.to("#cta", 0.1, { scale: 1.1, y: 0, transformOrigin: "85% 70%", z: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		};
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 0, transformPerspective: 970, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, "+=3.5")

			.to("#copy-3", 0.1,  { autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, '+=1.25')
	...
	nameSpace.walk = function() {
		...
		tl.to("#leg-1", 0.1, {rotation:10, yoyo:true, repeat:20});
		tl2.to("#leg-2", 0.1, {rotation:-10, yoyo:true, repeat:20}, "-=0.1");
		tl3.to('#rooster', 1.5 ,{x:-300,transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power0.easeInOut});
	}
