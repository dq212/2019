...
(function () {
	...
	nameSpace.init = function () {
		...
		// TweenMax.set("#rooster", {x:90, y:200, scale:2});
		TweenMax.set("#rooster-object",{scale:1.8, x:135, y:300})
		...
		click_through.onmouseover = function () {
			TweenMax.to("#cta", 0.1, { scale: 1.1, y: 0, transformOrigin: "50% 75%", z: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		};
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 0, transformPerspective: 300, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, "+=4")
	...
	nameSpace.startAnimation = function () {
		...
		TweenMax.delayedCall(6.5, nameSpace.walk);
		TweenMax.delayedCall(6.75, nameSpace.speak);
		// startBgImg();
	...
	nameSpace.walk = function() {
		...
		tl3.to('#rooster', 2.75 ,{x:width,transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power0.easeInOut});
	}
	...
	nameSpace.turn = function() {
		var tl = new TimelineMax();
		tl.to("#main", 0, {rotationY:180, transformOrigin:"55% 50%"})
		tl.to("#main", 0, {rotationY:0, transformOrigin:"55% 50%"}, "+=0.75")
	}
