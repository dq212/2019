...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set("#rooster-object",{scale:1.2, x:10, y:220})
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 0, transformPerspective: 160, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, "+=4")
	...
	nameSpace.turn = function() {
		...
		tl.to("#main", 0, {skewY:0, transformOrigin:"55% 50%"}, "+=0.75")
	}
