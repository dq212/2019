...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set("#rooster-object",{scale:1, x:-55, y:0})
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.fromTo("#copy-2", 0, { autoAlpha: 0 }, { autoAlpha: 0, transformPerspective: 728, force3D: true, rotationZ: 0.01, ease: Power2.easeOut }, "+=4")
